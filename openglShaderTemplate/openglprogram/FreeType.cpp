...
void make_dlist ( FT_Face face, char ch, GLuint list_base, GLuint * tex_base ) {
	...
	glBegin(GL_QUADS);
	glTexCoord2d(0.0f,0.0f); glVertex2f(0.0f,(GLfloat)bitmap.rows);
	glTexCoord2d(0.0f,(GLfloat)y); glVertex2f(0.0f,0.0f);
	glTexCoord2d((GLfloat)x,(GLfloat)y); glVertex2f((GLfloat)bitmap.width,0);
	glTexCoord2d((GLfloat)x,0.0f); glVertex2f((GLfloat)bitmap.width,(GLfloat)bitmap.rows);
	glEnd();
	glPopMatrix();
